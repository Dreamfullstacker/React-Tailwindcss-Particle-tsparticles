      ...
      <div className="container mx-auto lg:pt-0">
            ...
            <div className="sm:w-1/3 md:w-2/5 lg:w-2/6">
              <div className="mt-12 footer-contact wow fadeIn" data-wow-duration="1s" data-wow-delay="0.8s">
                ...
                <ul className="contact">
                  <li className='my-1'>+809272561823</li>
                  <li className='my-1'>info@gmail.com</li>
                  <li className='my-1'>www.yourweb.com</li>
                  <li className='my-1'>123 Stree New York City , United <br></br> States Of America 750.</li>
                </ul>
              </div> 
            </div>
          </div> 
        ...
        <div className="py-4 lg:py-8 border-t border-gray-200 footer-copyright">
          <p className="text-white">
              Template by <a className="duration-300 hover:text-theme-color-2" href="#" rel="nofollow" target="_blank">GrayGrids</a> and
              <a className="duration-300 hover:text-theme-color-2" href="#" rel="nofollow" target="_blank">UIdeck</a>
          </p>
        </div>
      </div>
